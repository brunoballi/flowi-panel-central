...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-zinc-50 px-4">
      ...
      >
        <h1 className="mb-1 text-xl font-semibold text-zinc-900">Panel central de Flowi</h1>
        <p className="mb-6 text-sm text-zinc-500">Acceso interno — equipo Flowi.</p>
        ...
        <input
          ...
          className="mb-6 w-full rounded-md border border-zinc-300 px-3 py-2 text-sm focus:border-zinc-500 focus:outline-none"
        />
